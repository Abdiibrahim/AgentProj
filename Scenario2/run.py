...
print "Starting Simulation: Scenario 2...\n"
pygame.init()
...
while True:
    ...
    if world.checkTargetsAquired():
        ...
        #        ["2", "1", "1", world.agentRed.targetsFound, world.agentRed.moves, float(world.agentRed.targetsFound/(world.agentRed.moves + 1)), np.max(world.agentRed.happiness), np.min(world.agentRed.happiness), np.mean(world.agentRed.happiness), np.std(world.agentRed.happiness), ((float(world.agentRed.targetsFound / (world.agentRed.moves + 1))) - np.min(world.agentRed.happiness))/(np.max(world.agentRed.happiness) - np.min(world.agentRed.happiness))],
        #        ["2", "1", "2", world.agentGreen.targetsFound, world.agentGreen.moves, float(world.agentGreen.targetsFound/(world.agentGreen.moves + 1)), np.max(world.agentGreen.happiness), np.min(world.agentGreen.happiness), np.mean(world.agentGreen.happiness), np.std(world.agentGreen.happiness), ((float(world.agentGreen.targetsFound / (world.agentGreen.moves + 1))) - np.min(world.agentGreen.happiness))/(np.max(world.agentGreen.happiness) - np.min(world.agentGreen.happiness))],
        #        ["2", "1", "3", world.agentBlue.targetsFound, world.agentBlue.moves, float(world.agentBlue.targetsFound/(world.agentBlue.moves + 1)), np.max(world.agentBlue.happiness), np.min(world.agentBlue.happiness), np.mean(world.agentBlue.happiness), np.std(world.agentBlue.happiness), ((float(world.agentBlue.targetsFound / (world.agentBlue.moves + 1))) - np.min(world.agentBlue.happiness))/(np.max(world.agentBlue.happiness) - np.min(world.agentBlue.happiness))],
        #        ["2", "1", "4", world.agentYellow.targetsFound, world.agentYellow.moves, float(world.agentYellow.targetsFound/(world.agentYellow.moves + 1)), np.max(world.agentYellow.happiness), np.min(world.agentYellow.happiness), np.mean(world.agentYellow.happiness), np.std(world.agentYellow.happiness), ((float(world.agentYellow.targetsFound / (world.agentYellow.moves + 1))) - np.min(world.agentYellow.happiness))/(np.max(world.agentYellow.happiness) - np.min(world.agentYellow.happiness))],
        #        ["2", "1", "5", world.agentPurple.targetsFound, world.agentPurple.moves, float(world.agentPurple.targetsFound/(world.agentPurple.moves + 1)), np.max(world.agentPurple.happiness), np.min(world.agentPurple.happiness), np.mean(world.agentPurple.happiness), np.std(world.agentPurple.happiness), ((float(world.agentPurple.targetsFound / (world.agentPurple.moves + 1))) - np.min(world.agentPurple.happiness))/(np.max(world.agentPurple.happiness) - np.min(world.agentPurple.happiness))]
        #    ]
        #myFile = open("scenario_2_iter_1.csv", "w")
        #with myFile:
